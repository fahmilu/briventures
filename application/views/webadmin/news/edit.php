...
<div class="container">
	...
	<div class="crumbs">
		...
		<ul class="crumb-buttons">
			<li><a href="<?php echo site_url('webadmin/news/data');?>"  title="Back to List"><i class="icon-hand-left"></i><span>BACK TO LIST</span></a></li>
		</ul>
	</div>
	<!-- /Breadcrumbs line -->
	...
	<div class="col-md-12">
		<div class="widget box">
			...
			<div class="widget-content">
				...
				<?php } ?>
				<form class="form-horizontal row-border" action="<?php echo site_url('webadmin/news/update'); ?>" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<?php if ($row->picture != '') { ?>
							<img src="<?php echo base_url('uploads/news/'.$row->picture); ?>" style="margin-bottom:10px;" id="imgInp" />
							<?php } else {?>
