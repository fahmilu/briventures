			...
			<div class="widget-content">
				...
				<?php if($this->session->flashdata('done')){ ?>
					<div class="alert alert-success fade in">
						<i class="icon-remove close" data-dismiss="alert"></i>
						<strong>Success!</strong> <?php echo 'White Paper '.$this->session->flashdata('done'); ?> 
					</div>
				<?php } ?>	
				<form class="form-horizontal row-border" action="<?php echo site_url('webadmin/news/update_whitepaper'); ?>" method="post" enctype="multipart/form-data">
