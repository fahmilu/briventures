	...
	<div class="col-md-12">
		<div class="widget box">
			...
			<div class="widget-content">
				...
				<?php } ?>
				<form class="form-horizontal row-border" action="<?php echo site_url('webadmin/banner/submit'); ?>" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							...
							<span class="help-block">Filetype: jpg, png, or gif, max size: 2MB, Max Resolution 2048x2048</span>
						</div>
					</div>									
					<div class="row">
