...
$( document ).ready( function() {
    ...
    $('input[name="tag"]').textext({plugins : 'tags autocomplete'}).bind('getSuggestions', function(e, data)
        {
            var list = [
                    <?php
                    foreach ($tag as $tag) {
	...
	<div class="col-md-12">
		<div class="widget box">
			...
			<div class="widget-content">
				...
				<?php } ?>
				<form class="form-horizontal row-border" action="<?php echo site_url('webadmin/portfolio/submit'); ?>" method="post" enctype="multipart/form-data">
...
<!-- 					<div class="form-group">
						...
						<div class="col-md-1">
							<input type="checkbox" class="checkbox form-control islisted" value="1" name="listed" />
						</div>
					</div> -->
					<div class="form-group listed_by" style="display: none;">
						<label class="col-md-2 control-label">Listed by:</label>
						<div class="col-md-3">
							<input type="text" name="listed_by" class="form-control" />
						</div>
					</div>					
					<div class="form-group">
						<label class="col-md-2 control-label">Positioning:</label>
						<div class="col-md-8">
							<input type="name" name="positioning" class="form-control">
						</div>
					</div>
					<div class="form-group">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="name" name="mail" class="form-control">
										</div>
									</div>
								</div>
								<div class="col-md-6">
