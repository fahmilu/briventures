...
<!-- Breadcrumbs line -->
	<div class="crumbs">
		...
		<ul class="crumb-buttons">
			<li><a href="<?php echo site_url('webadmin/portfolio/data/'); ?>" title="add data portfolio"><i class="icon-plus"></i><span>BACK TO LIST</span></a></li>
		</ul>
	</div>
	<!-- /Breadcrumbs line -->
	<!--=== Page Header ===-->
			...
			<div class="widget-content ">
				...
				<div class="row">
					<div class="table-footer">
						...
						<div class="col-md-6">
							<form class="form-horizontal row-border" action="<?php echo site_url('webadmin/portfolio/update_position'); ?>" method="post" enctype="multipart/form-data">
