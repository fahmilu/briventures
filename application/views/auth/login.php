...
<head>
	...
	<title>Login | BRI VENTURES WebAdmin</title>
	...
	<!-- Form Validation -->
	<script type="text/javascript" src="<?php echo base_url('assets/admin'); ?>/plugins/validation/jquery.validate.min.js"></script>

	<!-- Slim Progress Bars -->
	<script type="text/javascript" src="<?php echo base_url('assets/admin'); ?>/plugins/nprogress/nprogress.js"></script>
...
<body class="login">
	...
	<div class="logo">
		...
		BRI <span style="color: #ea6f23;">ventures</span> CMS
	</div>
	<!-- /Logo -->
	...
	<div class="box">
		<div class="content">
			<!-- Login Formular -->
			<form class="form-vertical login-form" action="<?php echo current_url(); ?>" method="post">
				...
				<div class="form-group">
					...
					<div class="input-icon">
						<i class="icon-user"></i>
						<input type="text" name="login" class="form-control" placeholder="Username" autofocus="autofocus" data-rule-required="true" data-msg-required="Please enter your username." />
					</div>
				</div>
				<div class="form-group">
	...
	<!-- /Login Box -->
	<!-- Footer -->
	<!-- <div class="footer">Copyright &copy; <strong>PT. Modern Data Solusi</strong></div> -->
	<!-- /Footer -->
</body>
</html>